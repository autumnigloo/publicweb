...
export class Game {
     ...
     */
    cone_params() {
        const ret = wasm.game_cone_params(this.__wbg_ptr);
     ...
     */
    enemies_data() {
        const ret = wasm.game_enemies_data(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    enemy_count() {
        const ret = wasm.game_enemy_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    fire_nova() {
        wasm.game_fire_nova(this.__wbg_ptr);
    }
    /**
     * @returns {number}
     */
    flash() {
        const ret = wasm.game_flash(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {boolean}
     ...
     */
    nova_charges() {
        const ret = wasm.game_nova_charges(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    nova_progress() {
        const ret = wasm.game_nova_progress(this.__wbg_ptr);
        return ret;
    }
    /**
     * 0 = lateral, 1 = disk
     ...
     */
    player_xyz() {
        const ret = wasm.game_player_xyz(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    set_keys(mask) {
        wasm.game_set_keys(this.__wbg_ptr, mask);
    }
    /**
     * @param {number} dt
     */
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cone_wars_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
